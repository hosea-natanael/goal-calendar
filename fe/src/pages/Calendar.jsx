...
export default function Calendar() {
    ...
    async function getCurrGoal() {
        ...
        const res = await fetch(
            "http://localhost:3000/calendar/" + params.calendarId +
    ...
    async function addGoal() {
        ...
        const res = await fetch("http://localhost:3000/goal-achieved", {
            method: "POST",
    ...
    async function removeGoal() {
        ...
        const res = await fetch("http://localhost:3000/goal-achieved/" + selectedGoal.id, {
            method: "DELETE",
            headers: { "Content-Type": "application/json", "Authorization": sessToken },
        })
        const json = await res.json()
